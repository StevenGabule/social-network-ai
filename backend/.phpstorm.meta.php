...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/social-network/backend/public/storage' => 'string',
            ...
            'passport.personal_access_client.id' => 'string',
            'passport.personal_access_client.secret' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./var/www/social-network/backend/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'hashing.rehash_on_login','concurrency.default','passport.guard','passport.private_key','passport.public_key',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','PASSPORT_PERSONAL_ACCESS_CLIENT_ID',
